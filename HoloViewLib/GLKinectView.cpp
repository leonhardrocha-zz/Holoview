...
void GLKinectView::SetupView()
{
	glMatrixMode(GL_PROJECTION);
	gluPerspective(45.0f, 4.0f/3.0f, 0.01f, 10.0f);
}

void GLKinectView::ResetScene()
{
...
void GLKinectView::SetupScene()
{
	glMatrixMode(GL_MODELVIEW);	
}

void  GLKinectView::RenderView()
{
	ResetView();	
	SetupView();
	{		
